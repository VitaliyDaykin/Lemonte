(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".company-team__slider")) new swiper_core_Swiper(".company-team__slider", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
        ...
        tabs.forEach((function(tab, index) {
            tab.addEventListener("click", (function() {
                ...
                images.forEach((function(img, imgIndex) {
                    if (index === imgIndex) img.style.opacity = "1"; else img.style.opacity = "0.3";
                }));
            }));
        }));
